      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 20, marginBottom: 48 }}>
            ...
            <span style={{ color: "white", fontSize: 44, fontWeight: 700, letterSpacing: "-1px" }}>
              Trigno
              <span style={{ color: "#6BB3F0" }}>tech</span>
            </span>
          </div>
          ...
          >
            ...
            <span style={{ color: "#4BA3F5" }}>Digital Excellence</span>
          </div>

          {/* Tagline */}
          <div style={{ color: "rgba(255,255,255,0.55)", fontSize: 26, letterSpacing: "0.5px" }}>
